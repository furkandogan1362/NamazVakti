/**
 * Haftalık Namaz Vakitleri Ekranı
 * 7 günlük namaz vakitlerini modern ve görsel olarak çekici bir liste şeklinde gösterir
 */
...
import { saveWeeklyLastShownDate, loadWeeklyLastShownDate } from '../services/storageService';
...
const WeeklyPrayerTimes: React.FC<WeeklyPrayerTimesProps> = ({ prayerTimes, onBack }) => {
    ...
    // Bugünden itibaren 7 günlük veriyi al (cache'lenmiş ve otomatik güncellenen)
    const weeklyData = useMemo(() => {
        const today = getTodayString();

        // Eğer tarih değiştiyse, yeni tarihi kaydet
        if (lastShownDate !== today) {
            saveWeeklyLastShownDate(today);
        ...
        >
            <Animated.View style={[styles.themeAnimatedContainer, { opacity: themeFadeAnim }]}>
                <View style={styles.header}>
                    ...
                    <Text style={styles.headerTitle}>Haftalık Namaz Vakitleri</Text>
                </View>
